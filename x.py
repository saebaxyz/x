...
def main():
  ...
  try:
	...
	print G+'[4] > Ambil Daftar Email Semua Teman'
	print G+'[5] help'
	print G+'[6] Intip Token'
	print G+'[7] Layar Lebar anti Ruwet'
	print G+'[8] EXIT'
...
'''
		...
		show_program()
		main()
	elif cek.lower() in ['exit','8'] :
		print "[!] Exiting Program"
		sys.exit()
	elif cek.lower() in ['help','5'] :
		info_ga()
		main()
