...
def dump_mail():
	...
	try:
		...
		#outh2 = open('output/h_' + n[0].split(' ')[0] +'_'+ i['id']+'.txt','w')
		...
		#with open('output/y_' + n[0].split(' ')[0] +'_'+ i['id']+'.txt') as outy:
		dataz = list(csv.reader(outy, delimiter=','))
		#sort by first array [0]
		m = sorted(dataz, key=lambda data_entry: int(data_entry[0]))
		#var outf, open file2
		with open('output/y_' + n[0].split(' ')[0] +'_'+ i['id']+'.txt', 'a') as outf:
		  csv.writer(outf, delimiter=',').writerows(m)
		outf.close();

		#with open('output/h_' + n[0].split(' ')[0] +'_'+ i['id']+'.txt') as outh2:
		dataz = list(csv.reader(outh, delimiter=','))
		#sort by first array [0]
		m = sorted(dataz, key=lambda data_entry: int(data_entry[0]))
		#var outf, open file2
